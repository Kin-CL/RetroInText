...
python get_cost.py
```
We also provide the dataset in the following link: [https://zenodo.org/records/14915301](https://zenodo.org/records/14915301), you can email the corresponding author for the dataset.
