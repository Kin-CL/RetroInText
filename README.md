...
### Train fusion model 
You should download the Scibert model before testing at [https://zenodo.org/records/14922390](https://zenodo.org/records/14922390), and put it in the ```./model/scibert```.
