...
parser.add_argument('--seed', type=int, default=166, help='Random seed.')
# ===================== model ====================== #
...
val_data = TensorDataset(val_representation, val_costs)
...
for epoch in trange(args.n_epochs):
    ...
    if val_loss / val_seen < best_val_loss:
        ...
        torch.save(model.state_dict(), 'value_function_mlp.pkl')